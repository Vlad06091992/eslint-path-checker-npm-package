    ...
    invalid: [
        {
            ...
            errors: [{ message: "Слой может импортировать в себя только нижележащие слои (shared,entities)"}],
            options: aliasOptions,
        },
        {
        ...
        {
            filename: 'C:\\Users\\tim\\Desktop\\javascript\\production_project\\src\\widgets\\page',
            code: "import { addCommentFormActions, addCommentFormReducer } from '@/app/Articl'",
            errors: [{ message: "Слой может импортировать в себя только нижележащие слои (features,shared,entities)"}],
            options: aliasOptions,
        },
    ],
});
